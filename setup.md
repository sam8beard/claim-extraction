...
Add an administrative user with the username and password that is set in `docker-compose.yml` and link it to the IP and port where the service is hosted
